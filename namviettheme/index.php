...
<div class="untree_co--site-main">
  <div class="owl-carousel owl-hero">
    <div class="untree_co--site-hero overlay" style="background-image: url('images/banner1.jpg')">
      <div class="container">
    ...
    <div class="untree_co--site-hero overlay" style="background-image: url('images/banner2.jpg')">
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-10">
            <div class="site-hero-contents text-center" data-aos="fade-up">
        ...
        <div class="suite">
          <div class="image-stack">
            ...
            <div class="image-stack-item image-stack-item-bottom">
              <div class="overlay"></div>
              <img src="images/pk1.jpg" alt="Image" class="img-fluid pic2">
            </div>
          </div>
        </div>
        ...
        <div class="suite">
          <div class="image-stack">
            <div class="image-stack-item image-stack-item-top">
              <div class="overlay"></div>
              <img src="images/pk2.jpg" alt="Image" class="img-fluid pic1">
            </div>
    ...
    <div class="container">
      ...
      <div class="row custom-row-02192 align-items-stretch">
        <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="100">
          <div class="media-29191 text-center h-100">
            <div class="media-29191-icon">
              <img src="images/pn1.jpg" alt="Image" class="img-fluid">
            </div>
            <h3>Quân 1</h3>
            <p>Mang lại vẻ đẹp tinh tế,sang trọng,Phòng làm việc kết hợp phòng khách</p>
            <p>
        ...
        <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="200">
          <div class="media-29191 text-center h-100">
            <div class="media-29191-icon">
              <img src="images/pk2.jpg" alt="Image" class="img-fluid">
            </div>
            <h3>Quân 2</h3>
            <p>Mang lại vẻ đẹp tinh tế,sang trọng,Phòng làm việc kết hợp phòng khách.</p>
            <p>
        ...
        <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="100">
          <div class="media-29191 text-center h-100">
            <div class="media-29191-icon">
              <img src="images/pn2.jpg" alt="Image" class="img-fluid">
            </div>
            <h3>Quận 3</h3>
            <p>Mang lại vẻ đẹp tinh tế,sang trọng,Phòng làm việc kết hợp phòng khách</p>
            <p>
        ...
        <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="200">
          <div class="media-29191 text-center h-100">
            <div class="media-29191-icon">
              <img src="images/nb2.jpg" alt="Image" class="img-fluid">
            </div>
            <h3>Quận 4</h3>
            <p>Mang lại vẻ đẹp tinh tế,sang trọng,Phòng làm việc kết hợp phòng khách</p>
            <p>
        ...
        <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="100">
          <div class="media-29191 text-center h-100">
            <div class="media-29191-icon">
              <img src="images/nb1.jpg" alt="Image" class="img-fluid">
            </div>
            <h3>Quận 5</h3>
            <p>Mang lại vẻ đẹp tinh tế,sang trọng,Phòng làm việc kết hợp phòng khách</p>
            <p>
        ...
        <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="200">
          <div class="media-29191 text-center h-100">
            <div class="media-29191-icon">
              <img src="images/np3.jpg" alt="Image" class="img-fluid">
            </div>
            <h3>Quận 6</h3>
            <p>Mang lại vẻ đẹp tinh tế,sang trọng,Phòng làm việc kết hợp phòng khách</p>
            <p>
